...
const WeeklySalesChart = () => {
  ...
  return (
    <div className="dark:bg-slate-700 bg-slate-50  p-8 rounded-lg shadow-xl mb-5">
      <h2 className="text-xl font-bold mb-4 text-slate-800 dark:text-slate-50">WeeklySales Chart</h2>
      <div className="p-4">
        {/* Tabs */}
                  ...
                  <button
                    ...
                    className={
                      chartToDisplay == tab.type
                        ? "inline-block p-4 text-orange-600  border-b-2 border-orange-600 active  rounded-t-lg active dark:text-orange-500 dark:border-orange-500"
